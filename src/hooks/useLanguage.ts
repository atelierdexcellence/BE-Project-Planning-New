...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'gantt.all_clients': 'All Clients',
    'gantt.all_commercials': 'All Commercials',
    'gantt.all_be_members': 'All BE Members',
    'gantt.sort_by_date': 'Sort by Next Date',
    'gantt.sort_by_client': 'Sort by Client',
    'gantt.sort_by_commercial': 'Sort by Commercial',
    'gantt.sort_by_be_member': 'Sort by BE Member',
    ...
    'task.be_prepare_fichiers': 'BE prépare fichiers découpe bois 2D / dossier atelier',
    ...
    'task.rdv_confort_atelier': 'Rdv confort test atelier',
    'task.rdv_confort_structure': 'RDV confort sur structure bois canapé',
    'task.modifs_mousse_confort': 'Modifs mousse post-rdv confort',
    'task.pose_sangles': 'Pose des sangles et/ou toile polypro',
    'task.modifs_bois_montage': 'Modifs bois post-montage proto',
    'task.placage_bois': 'Placage bois',
    'task.vernis_placage': 'Vernis placage bois',
    'task.rdv_validation_blanc': 'Rdv confort / validation mise en blanc',
    'task.modifs_mousse_blanc': 'Modifs mousse post-rdv confort',
    'task.livraison_ebeniste': 'Livraison EBENISTE',
    'task.control_qualite': 'Control Qualité',
    'task.depart_palette': 'Départ palette Moreau',
  ...
  fr: {
    ...
    'gantt.all_clients': 'Tous les Clients',
    'gantt.all_commercials': 'Tous les Commerciaux',
    'gantt.all_be_members': 'Tous les Membres BE',
    'gantt.sort_by_date': 'Trier par Prochaine Date',
    'gantt.sort_by_client': 'Trier par Client',
    'gantt.sort_by_commercial': 'Trier par Commercial',
    'gantt.sort_by_be_member': 'Trier par Membre BE',
